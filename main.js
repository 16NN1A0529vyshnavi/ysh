...
function education(edu){
  ...
  var tr="<tr> <th> Degree </th> <th> Institite </th> <th> data </th> </tr>";
  //tab.innerHTML=tr;
  var tr1="";
for(var i=0;i<edu.length;i++){
  tr1+="<tr> <td>"+edu[i].degree+"</td> <td> "+edu[i].instiute+" </td> <td>"+edu[i].data+"</td> </tr>"
}
...
function skills(sk){
  ...
  var hr=document.createElement("hr");
  heading.appendChild(hr);
  var skDiv=document.createElement("hr");
  heading.appendChild(hr);
